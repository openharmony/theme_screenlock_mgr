...
const uint32_t SCREENLOCK_BEGIN_WAKEUP = 0x00000001;
const uint32_t SCREENLOCK_END_WAKEUP = 0x00000004;
const uint32_t SCREENLOCK_BEGIN_SCREEN_ON = 0x00000008;
const uint32_t SCREENLOCK_END_SCREEN_ON = 0x00000010;
const uint32_t SCREENLOCK_BEGIN_SCREEN_OFF = 0x00000020;
const uint32_t SCREENLOCK_END_SCREEN_OFF = 0x00000040;
const uint32_t SCREENLOCK_UNLOCK_SCREEN = 0x00000080;
const uint32_t SCREENLOCK_BEGIN_SLEEP = 0x00000100;
const uint32_t SCREENLOCK_END_SLEEP = 0x00000200;
const uint32_t SCREENLOCK_CHANGE_USER = 0x00000400;
const uint32_t SCREENLOCK_SCREENLOCK_ENABLED = 0x00000800;
const uint32_t SCREENLOCK_EXIT_ANIMATION = 0x00001000;
const uint32_t SCREENLOCK_SYSTEM_READY = 0x00002000;
const uint32_t SCREENLOCK_LOCK_SCREEN = 0x00004000;
} // namespace ScreenLock
} // namespace OHOS
