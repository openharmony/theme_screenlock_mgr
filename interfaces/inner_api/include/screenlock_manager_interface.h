...
public:
    ...
    virtual int32_t IsLockedWatch(bool isPaymentApp, bool &isLocked) = 0;
    virtual int32_t UnlockWatch(bool isPaymentApp, const sptr<ScreenLockCallbackInterface> &listener) = 0;
